...
INSERT INTO rule_input_article (rule_id, code, description, amount, in_catalogue) VALUES
  (1, '00001', 'Default input article 1', 5, TRUE),
  (1, '00002', 'Default input article 2', 5, TRUE);

INSERT INTO rule_output_article (rule_id, code, description, amount, in_catalogue) VALUES
